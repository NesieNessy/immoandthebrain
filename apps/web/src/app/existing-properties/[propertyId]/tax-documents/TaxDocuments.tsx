...
import { Button, ConfirmDeleteModal, FilePickerButton, Header, Icons, Modal, NumberField, PAGE_CONTAINER_CLASS, SectionLabel, StickyActionBar, Tag, TextField } from '@/components/ui';
...
function YearCard({ summary, selected, onSelect }: { summary: TaxYearBreakdown; selected: boolean; onSelect: () => void }) {
    ...
    return (
        ...
        >
            <div className="flex items-center justify-between gap-2">
                <span className="text-lg font-bold text-foreground">{summary.year}</span>
                <Tag
            ...
            <p className="mt-3 text-xs text-muted-foreground uppercase tracking-wide">Gesamtbetrag</p>
            ...
            <div className="flex items-center justify-between text-xs text-muted-foreground">
                <span>Belege</span>
                <span className="font-medium text-foreground">{summary.uploadedCategoryCount} / {summary.categoryCount}</span>
            </div>
        </button>
    );
}
