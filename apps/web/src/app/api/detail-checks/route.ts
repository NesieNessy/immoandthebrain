  ...
  const { rows } = await db.query(
    `
      SELECT
        ...
        dep.depreciation_mode,
        dep.price_split_mode,
        dep.modernization_roof,
        dep.modernization_windows,
        dep.modernization_lines,
        dep.modernization_heating,
        dep.modernization_facade,
        dep.modernization_bathrooms,
        dep.modernization_interior,
        dep.remaining_useful_life_years,
        dep.afa_percent,
        dep.plot_area_m2,
        dep.land_reference_value,
        dep.co_ownership_numerator,
        dep.co_ownership_denominator,
